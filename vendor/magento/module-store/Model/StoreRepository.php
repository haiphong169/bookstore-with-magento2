...
class StoreRepository implements \Magento\Store\Api\StoreRepositoryInterface
{
    ...
    public function get($code)
    {
        ...
        if ($store->getId() === null) {
            throw new NoSuchEntityException(
                __("code: {$code} The store that was requested wasn't found. Verify the store and try again.")
            );
        }
    ...
    public function getById($id)
    {
        ...
        if ($store->getId() === null) {
            throw new NoSuchEntityException(
                __("id: {$id} The store that was requested wasn't found. Verify the store and try again.")
            );
        }
